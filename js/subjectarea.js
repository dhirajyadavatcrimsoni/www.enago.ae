...
selbox5.options[selbox5.options.length] = new Option('أخرى','Others');
document.frmSubmit.R2.disabled = false;
document.getElementById("span1").innerHTML  = "كلمة البحث";
document.frmSubmit.txtRef.disabled = false;
...
selbox5.options[selbox5.options.length] = new Option('صديق / زميل','Friend/Colleague');
selbox5.options[selbox5.options.length] = new Option('جامعة/معهد/منظمة','University/Institute/Organization');
document.frmSubmit.R2.disabled = false;
document.getElementById("span1").innerHTML  = "اسم";
document.frmSubmit.txtRef.disabled = false;
document.getElementById("r2").style.display			= "block";
document.getElementById("r2").style.visibility		= "visible";
document.getElementById("message").style.display			= "block";
...
document.frmSubmit.R2.disabled = true;
document.getElementById("span1").innerHTML  = "عنوان انترنت (URL)/اذكر أين وجدت العنوان.";
document.frmSubmit.txtRef.disabled = false;
document.getElementById("message").style.display			= "block";
document.getElementById("message").style.visibility		= "visible";
document.getElementById("r2").style.display			= "none";
...
document.frmSubmit.R2.disabled = true;
document.getElementById("span1").innerHTML  = "اسم المجلة/ عنوان انترنت (URL)";
document.frmSubmit.txtRef.disabled = false;
document.getElementById("message").style.display			= "block";
document.getElementById("message").style.visibility		= "visible";
document.getElementById("r2").style.display			= "none";
...
if (chosen == "Others") {
document.frmSubmit.R2.disabled = true;
document.getElementById("span1").innerHTML  = "اسم/عنوان انترنت (URL)";
document.frmSubmit.txtRef.disabled = false;
document.getElementById("message").style.display			= "block";
document.getElementById("message").style.visibility		= "visible";
document.getElementById("r2").style.display			= "none";
